...
export default function UpdatePasswordPage() {
  ...
  // Supabase automatically parses the access_token from the URL hash when the
  // page loads and fires onAuthStateChange with event PASSWORD_RECOVERY.
  // We listen for that to confirm the session is valid before showing the form.
  useEffect(() => {
  ...
  // Redirect to /players 2 seconds after success
  useEffect(() => {
    if (!success) return
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '28px' }}>
              ...
              <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '36px', letterSpacing: '0.05em', color: '#f5edd6', margin: 0 }}>
                {success
                  ? <>Password <span style={{ color: '#c4822a' }}>Updated</span></>
                  : <>Set New <span style={{ color: '#c4822a' }}>Password</span></>
                }
              </h1>
            ...
            {success ? (
              ...
              /* Waiting for the token to be parsed from the URL hash */
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
                ...
                <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: '13px', letterSpacing: '0.06em', color: 'rgba(245,237,214,0.4)', margin: 0 }}>
